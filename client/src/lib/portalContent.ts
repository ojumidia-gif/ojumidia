...
export const portalContentDefaults = {
  Global: {
    navigation: { items: [
      ...
      { label: "Instituições", href: "/instituicoes", order: 9, active: true, featured: false },
      { label: "Agenda", href: "/agenda", order: 10, active: true, featured: false },
      { label: "Memórias", href: "/memorias", order: 11, active: true, featured: false },
      { label: "Vozes da Rede", href: "/vozes-da-rede", order: 12, active: true, featured: false },
      { label: "Acervo", href: "/acervo", order: 13, active: true, featured: false },
      { label: "Serviços", href: "/servicos", order: 14, active: true, featured: false },
      { label: "Chamar a Ojú", href: "/planejar-um-registro", order: 15, active: true, featured: true },
      { label: "Ser parceiro", href: "/ser-parceiro", order: 16, active: true, featured: false },
    ] },
    ...
    method: { eyebrow: "Método Ojú", title: "Cuidado antes da câmera.", description: "Registrar começa quando a Ojú compreende o que está sendo vivido.", items: ojuMethod },
  },
  Home: {
