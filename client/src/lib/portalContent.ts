...
export const portalContentDefaults = {
  ...
  Home: {
    ...
    featured: { eyebrow: "Em destaque", title: "Histórias recentes", emptyMessage: "Os próximos conteúdos publicados aparecerão nesta faixa.", allLabel: "Ver todas", allHref: "/acervo" },
