...
export default function TaxonomiesAdmin() {
  ...
  return <AdminPage eyebrow={territoriesFocus ? "Portal → Territórios" : "Territórios e taxonomias"} title={territoriesFocus ? "Cadastrar, editar e publicar no mapa." : "Criar, relacionar e documentar."} action={null}>
    {territoriesFocus ? <p className="-mt-4 mb-4 max-w-3xl text-sm leading-6 text-[#655e52]">Cadastre o território. Depois ligue histórias e coberturas no conteúdo. Visibilidade no mapa é opcional e só com autorização da casa. Você edita só o que cadastrou; o catálogo nacional fica com o Super Admin.</p> : null}
