...
import { Film, Save, UploadCloud } from "lucide-react";
...
export default function MiniclipsAdmin() {
  ...
  async function upload(event: React.FormEvent) {
    ...
    try {
      ...
      stage.clear(); setOrigin(""); setCredit("");
  ...
  return <AdminPage eyebrow="Super Admin · Home nacional" title="Miniclipes do fundo vivo.">
    <p className="-mt-4 mb-6 max-w-3xl text-sm leading-6 text-[#655e52]">Esta sequência alimenta só a Home nacional. Parceiros não curam este fundo: o território publica conteúdo, não a vitrine da entrada do portal.</p>
