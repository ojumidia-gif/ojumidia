...
export default function PartnersAdmin() {
  ...
  return <AdminPage eyebrow="Governança territorial" title="Parceiros Ojú e escopos operacionais." action={<Link href="/admin/colaboradores" className="rounded-full border border-[#242017] px-4 py-2 text-sm font-bold">Gerir colaboradores</Link>}>
