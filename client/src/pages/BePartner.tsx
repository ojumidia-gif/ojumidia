    ...
    <div className="public-page overflow-x-hidden">
      ...
      <main className="container grid gap-10 pb-20 pt-28 sm:gap-12 sm:pt-16 lg:grid-cols-[1.05fr_.95fr]">
        <section>
          ...
          <p className="mt-6 max-w-xl text-base leading-7 text-oju-terra-suave">Este canal não cria login. Você conta quem é, onde atua e o que já faz. A Equipe Ojú lê, conversa e só então libera o acesso de criador parceiro — com termo via gov.br quando couber.</p>
          <ul className="mt-10 grid gap-4 text-sm leading-6 text-oju-terra-suave">
            <li><b className="text-oju-terra">O que você passa a fazer.</b> Como criador parceiro: criar, editar e publicar o que é seu — histórias, coberturas, fotos, casas e agenda do território. Não mexe no conteúdo de outro parceiro nem na Home nacional.</li>
            <li><b className="text-oju-terra">Visibilidade.</b> O que você publica com autorização entra no portal (histórias, coberturas, territórios, fotógrafos). Destaque na Home continua sendo curadoria nacional.</li>
        ...
        <section className="h-fit rounded border border-oju-terra/12 bg-oju-paz-claro p-6 sm:p-8">
          {sent ? (
            ...
            <form className="grid gap-4" onSubmit={onSubmit}>
              ...
              <label className="grid gap-2 text-sm">Território ou cidade<input required name="territory" className="h-11 w-full min-w-0 rounded border border-oju-terra/12 bg-oju-paz-claro px-3 text-oju-terra" /></label>
