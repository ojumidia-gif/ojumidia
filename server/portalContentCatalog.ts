...
export const PORTAL_DEFAULT_BLOCKS: Array<{
...
}> = [
  {
    ...
    content: { items: [
      ...
      { label: "Vozes da Rede", href: "/vozes-da-rede", order: 11, active: true, featured: false },
      { label: "Acervo", href: "/acervo", order: 12, active: true, featured: false },
      { label: "Serviços", href: "/servicos", order: 13, active: true, featured: false },
      { label: "Chamar a Ojú", href: "/planejar-um-registro", order: 14, active: true, featured: true },
      { label: "Ser parceiro", href: "/ser-parceiro", order: 15, active: true, featured: false },
    ] },
  },
  {
    page: "Global",
  ...
  },
  {
    ...
    displayOrder: 30,
    content: { eyebrow: "Em destaque", title: "Histórias recentes", emptyMessage: "A Home mostra somente conteúdos escolhidos pela curadoria nacional. Publicar no portal não coloca a capa aqui.", allLabel: "Ver acervo", allHref: "/acervo" },
  },
  {
    page: "Home",
